...
public class BpTrend {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		for(int i=0;i<collectedData.size();i++)
			System.out.println(collectedData.get(i).getAirTemp());

		
		convertToF(collectedData);
	...
	private static void convertToF(ArrayList<WeatherEntry> collectedData) {
		for(int i=0; i<collectedData.size();i++){
			collectedData.get(i).changeAirMeasurement();
		}
	}
